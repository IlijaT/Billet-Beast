...
class HashidsTicketCodeGeneratorTest extends TestCase
{
  ...
  /** @test */
  public function ticket_codes_only_contain_uppercase_letters()
  {
    $ticketCodeGenerator = new HashidsTicketCodeGenerator('testsalt1');
  ...
  /** @test */
  public function ticket_code_for_the_same_ticket_id_are_the_same()
  {
    $ticketCodeGenerator = new HashidsTicketCodeGenerator('testsalt1');
    ...
    $this->assertEquals($code1, $code1);

  }

  /** @test */
  public function ticket_code_for_different_ticket_ids_are_different()
  {
    $ticketCodeGenerator = new HashidsTicketCodeGenerator('testsalt1');
  ...
  /** @test */
  public function ticket_codes_generated_for_different_salts_are_different()
  {
